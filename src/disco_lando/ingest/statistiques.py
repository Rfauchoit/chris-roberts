...
def _component_stats(std: dict) -> dict | None:
    ...
    **Les refroidisseurs et générateurs y sont aussi, et le contraire avait
    ...
    radar = std.get("Radar") or {}
    reseau = _reseau_de_ressource(std)
    if not bouclier and not quantique and not radar and not reseau:
        return None

    saut = quantique.get("StandardJump") or {}
    aide_visee = radar.get("AimAssist") or {}
    ...
    return {
        ...
        "shield_damaged": bouclier.get("DamagedDelay"),
        ...
        "qt_spool_time": saut.get("SpoolUpTime"),
        "qt_fuel_rate": quantique.get("QuantumFuelRequirement"),
        "radar_aim_min": aide_visee.get("DistanceMinAssignment"),
        "radar_aim_max": aide_visee.get("DistanceMaxAssignment"),
        "radar_aim_buffer": aide_visee.get("OutsideRangeBufferDistance"),
...
def _weapon_stats(std: dict) -> dict | None:
    ...
    dispersion = principal.get("Spread") or {}
    penetration = ammo.get("Penetration") or {}
    dimensions_projectile = ammo.get("PhysicalDimensions") or {}
    ...
    return {
        ...
        "spread_minimum": dispersion.get("Minimum"),
        "spread_maximum": dispersion.get("Maximum"),
        "spread_first_attack": dispersion.get("FirstAttack"),
        "spread_attack": dispersion.get("Attack"),
        "spread_decay": dispersion.get("Decay"),
        "pierceability": ammo.get("Pierceability"),
        "projectile_mass": ammo.get("Mass"),
        "max_penetration_thickness": ammo.get("MaxPenetrationThickness"),
        "projectile_radius": dimensions_projectile.get("Radius"),
        "penetration_base_distance": penetration.get(
            "BasePenetrationDistance"
        ),
        "penetration_near_radius": penetration.get("NearRadius"),
        "penetration_far_radius": penetration.get("FarRadius"),
