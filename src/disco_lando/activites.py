...
def _cle_de_tri(tri: str):
    ...
    if tri == "debutant":
        # **La nature d'abord** — les chaînes guidées avant les activités
        # libres —, puis le rang d'entrée, puis la difficulté. Les boucles
        # sont écartées en amont, dans `activites_a_faire`.
        return lambda f: (
