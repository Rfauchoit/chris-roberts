...
from .equipement import (  # noqa: F401  (réexportés pour les appelants)
    ...
    question_hors_famille_equipement,
)
...
from .flotte import (  # noqa: F401  (réexportés
    _METIERS, _ships_nommes, combien_dans_la_soute, compare_ships,
    comparer_loadouts, detect_metier, get_ship_components,
    get_ship_hardpoints, get_ship_stats, marges_d_upgrade,
    vaisseau_pour_budget, vaisseaux_au_seuil, vaisseaux_multi_criteres,
    vaisseaux_par_metier, vaisseaux_sans_composant,
)


# Armurerie — voir [armurerie.py](armurerie.py).
from .armurerie import (  # noqa: F401  (réexportés)
    catalogue_objets, detect_famille_objets, question_hors_famille, rayon_fr,
...
from .combat import (  # noqa: F401  (réexportés)
    bataille, matchups_vaisseau, peut_detruire, simuler_duel,
)
...
from .guilde.questions import (  # noqa: F401
    armes_qui_marchent, jamais_essaye, missions_guilde,
    possessions_guilde,
)
...
from .fabrication import (  # noqa: F401  (réexportés)
    blueprints_de_la_meme_serie, extraire_rang_actuel, fabricateur,
    get_blueprint, plan_de_fabrication, reponse_vide,
)
...
from .activites import (  # noqa: F401  (réexportés)
    LIBELLES_COMBAT, LIBELLES_MISSION, LIBELLES_NATURE, LIBELLES_PVP,
    LIBELLES_STATUT, LIBELLES_TRI, catalogue_activites, difficulte_cig,
    fiche_activite, resoudre_activite, activites_a_faire, par_ou_commencer,
    LIBELLES_PREUVE, quoi_de_neuf,
)
