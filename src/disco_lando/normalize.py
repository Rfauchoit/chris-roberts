...
MOTS_GRAMMATICAUX = frozenset({
    ...
    # « font » manquait alors que « fait » et « faire » y sont depuis le
    # début. Mesuré le 2026-08-20 : « quelles armes **font** plus de 500
    # dps » lisait le verbe comme un nom et sortait la commodité
    # `CO<font size="%d">2</font>` — le nom porte littéralement « font »,
    # donc `mots_inexpliques` ne peut pas le rattraper. Zéro alias ne
    # s'appelle « font » : l'ajout ne coûte rien.
    "font",
